                      ...
                      if(customerName==''|| address=='' || mobile==''){
                        ...
                        if(inside == 'not'){
                          if(customerEdit.value==true){
                            ...
                            String body='$customerName~$address~$mobile~$vat~$selectedPrice~$customerBalance~${flatNoController.text}~${buildNoController.text}~${roadNoController.text}~${blockNoController.text}~${areaNoController.text}~${landmarkNoController.text}~${customerNoteController.text}';
                    ...
                    onPressed:uploadDataEnable==true? ()async {
                      ...
                      if(importSelect.value=='Product') {
                        ...
                        await uploadCustomer(
                            ...
                            importCMobileNo,
                            importCVatNo,
                            importCBalance, importCPriceList);
                      }
                      else if(importSelect.value=='Vendor') {
                        await uploadVendor(
